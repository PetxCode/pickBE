...
exports.completePaymentEmailForClient =
  exports.completePaymentEmail =
...
const url = "https://pickstudionow.web.app";
      ...
      const html = yield ejs_1.default.renderFile(myPath, {
        ...
        receipt:
          (_a = data === null || data === void 0 ? void 0 : data.data) ===
            ...
            : _a.reference,
        amount:
          (_b = data === null || data === void 0 ? void 0 : data.data) ===
            null || _b === void 0
            ? void 0
            : _b.amount,
        channel:
          (_c = data === null || data === void 0 ? void 0 : data.data) ===
            null || _c === void 0
            ? void 0
            : _c.channel,
        currency:
          (_d = data === null || data === void 0 ? void 0 : data.data) ===
            null || _d === void 0
            ? void 0
            : _d.currency,
        paid_at: (0, moment_1.default)(
          (_e = data === null || data === void 0 ? void 0 : data.data) ===
            null || _e === void 0
            ? void 0
            : _e.paid_at
        ).format("LLLL"),
...
const completePaymentEmail = (user, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result = Object.entries(
        data === null || data === void 0 ? void 0 : data.bookedDate
      )
      ...
      const html = yield ejs_1.default.renderFile(myPath, {
        ...
        bookedDate:
          data === null || data === void 0 ? void 0 : data.calendarDate,
...
const completePaymentEmailForClient = (client, user, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // const accessToken: any = (await oAuth.getAccessToken()).token;
      const transporter = nodemailer_1.default.createTransport({
      ...
      const myPath = path_1.default.join(
        __dirname,
        "../views/completePaleteForClient.ejs"
      );
      const html = yield ejs_1.default.renderFile(myPath, {
        userName: user.firstName,
